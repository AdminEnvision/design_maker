    ...
    <div className="absolute left-full ml-3 flex flex-wrap space-y-2  overflow-y-scroll w-40 h-80">
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          ...
          onClick={() =>
            handlePositionChange("front", 0, snap.frontTextPosition[0] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handlePositionChange("front", 1, snap.frontTextPosition[1] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handlePositionChange("front", 2, snap.frontTextPosition[2] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleRotationChange("front", 0, snap.frontTextRotation[0] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleRotationChange("front", 1, snap.frontTextRotation[1] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleRotationChange("front", 2, snap.frontTextRotation[2] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleScaleChange("front", 0, snap.frontTextScale[0] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleScaleChange("front", 1, snap.frontTextScale[1] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleScaleChange("front", 2, snap.frontTextScale[2] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handlePositionChange("back", 0, snap.backTextPosition[0] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handlePositionChange("back", 1, snap.backTextPosition[1] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handlePositionChange("back", 2, snap.backTextPosition[2] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleRotationChange("back", 0, snap.backTextRotation[0] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleRotationChange("back", 1, snap.backTextRotation[1] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleRotationChange("back", 2, snap.backTextRotation[2] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleScaleChange("back", 0, snap.backTextScale[0] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleScaleChange("back", 1, snap.backTextScale[1] - 0.01)
          }
        >
          -
        </button>
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          className="border border-gray-300 rounded-md p-2"
          onClick={() =>
            handleScaleChange("back", 2, snap.backTextScale[2] - 0.01)
          }
        >
          -
        </button>
